document.addEventListener('DOMContentLoaded', () => {
  ...
  launchBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
      ...
      document.body.classList.add('app-active'); // Switches body bg to dark
    }, 300);
  });
  ...
  backBtn.addEventListener('click', () => {
    ...
    document.body.classList.remove('app-active'); // Switches body bg to light
  ...
  function renderAnalysis(product) {
    ...
    let dosageScore = 85, purityScore = 90, transparencyScore = 80;
    const findings = [];
